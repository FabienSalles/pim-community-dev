    ...
    function (
        ...
        return BaseForm.extend({
            ...
            getMissingRequiredAttributesCount: function (scope, locale) {
                ...
                const levelAttributeCodes = product.meta.attributes_for_this_level;
                const missingLevelAttributes = levelAttributeCodes.filter(
                    levelAttribute => missingAttributeCodes.includes(levelAttribute)
                );
